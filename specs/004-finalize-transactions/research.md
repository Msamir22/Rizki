...
This assumes that account balance = sum of all transactions. But in Astik:
...
[transfer-service.ts](file:///E:/Work/My%20Projects/Astik/apps/mobile/services/transfer-service.ts).
